...
const AppointmentDetails: React.FC<AppointmentDetailsProps> = ({
  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-4 space-y-4">
      ...
      <div>
        <Select
          label={<span className="text-sm font-medium text-gray-900">Appointment Type</span>}
      ...
      <div>
        <Select
          label={<span className="text-sm font-medium text-gray-900">Payment Status</span>}
